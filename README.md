...
### 工夫した点
コード生成AIに的確に指示が出せるよう、
ログを出力し、長押しでCopyできるようにしたところ。
そうすることで、問題解決までの指示出しがスムーズになった。
...
- **設定画面**: Supabase の PostgreSQL と連携
...
### AI音楽の先生（音声ファイル解析）
- **動画アップロード**: 端末から画像選択・Supabaseストレージへアップロード
- **動画解析**: Gemini APIによる画像内容の分析・数式解答
...
## 画面イメージ
<img src="docs/demo_1_全体.gif" width="300" />
<img src="docs/demo_2_AI画像解析.gif" width="300" />
